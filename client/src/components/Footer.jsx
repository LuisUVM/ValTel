      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">Avenida Páez, entre calles 5 y 6, Sector Centro.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/testimonios" className="text-gray-300 hover:text-white transition">Testimonios</Link></li>
              <li><Link to="/reservas" className="text-gray-300 hover:text-white transition">Reservas</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300">Recepción: 24/7</p>
            <p className="text-gray-300">Restaurante: 7:00 AM - 10:00 PM</p>
            <p className="text-gray-300">Spa: 9:00 AM - 8:00 PM</p>
          </div>
        </div>
